...
​    [官网](https://www.jetbrains.com/webstorm/download/other.html)

#### 2 激活

1. 下载[jetbra.rar](http://ys-c.ysepan.com/615464658/218220736/k356K3H5I54MKMVGSLjIf9/jetbra.rar)，解压复制文件夹到固定位置，以后不要删除，运行 `script` 文件夹下的 `install-current-user.vbs` 脚本，等待弹出 `done` 对话框
